...
# 1 gpu
python train.py --kernel-type 9c_b3_384_384_ext_10ep_us4 --init-lr 1e-5 --batch-size 32 --data-dir ./data/ --data-folder 384 --image-size 384 --enet-type efficientnet_b3 --n-epochs 10 --num_workers 16 --CUDA_VISIBLE_DEVICES 0
